...
const { getInventoryReport, getProfitReport, getProfitGraph } = require('../controllers/reportController');
const { getHistoricalSalesReport } = require('../controllers/historicalSalesReportController');
...
router.get('/sales', requirePermission('reports:read'), requireReportScope, requireReportDateRange, getHistoricalSalesReport);
