...
const ownerDailyDigestRoutes = require('./ownerDailyDigestRoutes');
...
const { getCategoryPerformance } = require('../controllers/tenant/categoryPerformanceV1Controller');
...
router.use('/owner-digest', ownerDailyDigestRoutes);
