...
describe('V1 Reporting/Admin permission authority', () => {
  ...
  test('branch-restricted users without a trusted branch fail closed', () => {
    const req = {
      path: '/sales',
      query: {},
      user: { type: 'tenant', role: 'manager', all_branch_access: false, branch_id: null },
    };
    const res = {
      statusCode: 200,
      body: null,
  ...
  test('all-branch report users may request one branch or tenant-wide scope', () => {
    const branchReq = {
      path: '/sales',
      query: { branch_id: '33333333-3333-4333-8333-333333333333' },
    ...
    expect(branchReq.reportBranchId).toBe('33333333-3333-4333-8333-333333333333');
