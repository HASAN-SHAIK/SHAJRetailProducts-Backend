...
describe('V1 expense create malformed bearer authorization', () => {
  const originalSecret = process.env.JWT_SECRET;

  beforeAll(() => {
    process.env.JWT_SECRET = 'cycle-a-expense-create-test-secret';
  });
  ...
  test('malformed bearer fails closed before tenant resolution or expense mutation', async () => {
